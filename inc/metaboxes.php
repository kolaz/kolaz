...
add_action('add_meta_boxes', 'kolaz_add_custom_box');
/**
 * Add Meta Boxes.
 *
 * Add Meta box in page and post post types.
 */
function kolaz_add_custom_box()
{
...
add_action('save_post', 'kolaz_save_custom_meta');
/**
 * save the custom metabox data
 * @hooked to save_post hook
 */
function kolaz_save_custom_meta($post_id)
{
    global $site_layout, $post;
