...
if ( ! function_exists( 'kolaz_paging_nav' ) ) :
/**
 * Display navigation to next/previous set of posts when applicable.
 *
 * @return void
 */
function kolaz_paging_nav() {
...
if ( ! function_exists( 'kolaz_post_nav' ) ) :
/**
 * Display navigation to next/previous post when applicable.
 *
 * @return void
 */
function kolaz_post_nav() {
...
if ( ! function_exists( 'kolaz_comment' ) ) :
/**
 * Template for comments and pingbacks.
 *
 * Used as a callback by wp_list_comments() for displaying the comments.
 */
function kolaz_comment( $comment, $args, $depth ) {
...
if ( ! function_exists( 'kolaz_posted_on' ) ) :
/**
 * Prints HTML with meta information for the current post-date/time and author.
 */
function kolaz_posted_on() {
 ...
 */
function kolaz_categorized_blog() {
 ...
 */
function kolaz_category_transient_flusher() {
	// Like, beat it. Dig?
	delete_transient( 'all_the_cool_cats' );
}
add_action( 'edit_category', 'kolaz_category_transient_flusher' );
add_action( 'save_post',     'kolaz_category_transient_flusher' );
